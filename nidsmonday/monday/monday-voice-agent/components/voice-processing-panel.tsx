        ...
        {isThinking ? (
          ...
          <div className="h-full flex flex-col flex-1">
            ...
            {voiceActive && liveTranscript && !isThinking && conversationMode && (
              <div className="mb-4 p-3 bg-gradient-to-r from-green-500/20 to-blue-500/20 border border-green-400/30 rounded-xl">
                <div className="flex items-center gap-2 mb-2">
                  <div className="w-2 h-2 bg-green-400 rounded-full animate-pulse"></div>
                  <span className="text-green-400 font-semibold text-xs">LIVE RECOGNITION:</span>
                </div>
